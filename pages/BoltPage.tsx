    ...
    <div className="bg-black min-h-screen">
      ...
      <section className="relative h-[50vh] flex items-center overflow-hidden border-b border-yellow-400/20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full text-center md:text-left">
          ...
          <p className="text-zinc-400 max-w-2xl text-lg font-medium border-l-2 border-yellow-400 pl-6 uppercase tracking-widest mx-auto md:mx-0">
            Zarabiaj z G&K – najniższe prowizje i najlepsze warunki w regionie.
          </p>
        </div>
      </section>

      {/* Conditions Section (Sama Treść) */}
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 border-t border-zinc-900">
        <div className="grid md:grid-cols-2 gap-16">
          <div className="space-y-6">
            <h3 className="text-2xl font-black text-white uppercase tracking-tighter italic">Dlaczego my?</h3>
            <div className="h-1 w-12 bg-yellow-400"></div>
            <p className="text-zinc-500 text-sm font-bold uppercase leading-relaxed tracking-widest">
              Jako oficjalny partner Bolt, zapewniamy pełną transparentność rozliczeń. Nie musisz martwić się o formalności – my zajmujemy się dokumentacją, serwisem auta i ubezpieczeniem. Ty po prostu wsiadasz i zarabiasz. Nasza flota to wyłącznie nowoczesne, ekonomiczne auta hybrydowe, które minimalizują koszty paliwa.
            </p>
          </div>
          <div className="space-y-6">
            <h3 className="text-2xl font-black text-white uppercase tracking-tighter italic">Dla kogo?</h3>
            <div className="h-1 w-12 bg-yellow-400"></div>
            <p className="text-zinc-500 text-sm font-bold uppercase leading-relaxed tracking-widest">
              Szukasz dodatkowego zajęcia? A może chcesz pracować na pełen etat? Nasza oferta jest elastyczna. Zapraszamy studentów, uczniów (ukończone 18 lat + prawo jazdy) oraz osoby szukające stabilnego dochodu w dynamicznej branży transportowej. G&K to gwarancja wypłaty zawsze na czas.
            </p>
          </div>
        </div>
      </section>
